...
import com.vanthan99.batdongsan.webservices.payload.request.PostSearchRequest;
...
public class PostController {
    ...
    public ResponseEntity<Object> updatePostViewCount(@PathVariable Long id, @RequestBody Post post) {
        post.setId(id);
        if (postService.findById(id) == null) {
            return new ResponseEntity<>(new ApiResponse(false, "Can not find this post!"), HttpStatus.NOT_FOUND);
        }
